...
@router.post("/token", response_model=Token, tags=["Users and Authentication"])
async def login(
...
@router.post("/user/", tags=["Users and Authentication"])
...
@router.get("/user/{name}/", response_model=User, tags=["Users and Authentication"])
...
@router.put("/user/{name}/", tags=["Users and Authentication"])
...
@router.delete("/user/{name}/", tags=["Users and Authentication"])
...
@router.get("/user/", response_model=list[User], tags=["Users and Authentication"])
